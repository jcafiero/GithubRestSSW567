...
class TestGithubRESTAPI(unittest.TestCase):
    ...
    def testJcafiero(self, mock_get):
        ...
        mock_responses[2].json.return_value = [{'commit': 2}, {'commit': 16}]
        mock_responses[3].json.return_value = [{'commit': 2}, {'commit': 15}]
        mock_responses[4].json.return_value = [{'commit': 2}, {'commit': 9}, {'commit': 10}, {'commit': 11}, {'commit': 12}]
        mock_responses[5].json.return_value = [{'commit': 2}, {'commit': 20}]
        mock_responses[6].json.return_value = [{'commit': 2}, {'commit': 2}]
        mock_responses[7].json.return_value = [{'commit': 2}, {'commit': 30}]
        mock_responses[8].json.return_value = [{'commit': 2}, {'commit': 28}]
        mock_responses[9].json.return_value = [{'commit': 2}, {'commit': 4}]
        mock_responses[10].json.return_value = [{'commit': 2}, {'commit': 2}]
        mock_responses[11].json.return_value = [{'commit': 2}, {'commit': 30}]
        mock_responses[12].json.return_value = [{'commit': 2}, {'commit': 12}]
        mock_responses[13].json.return_value = [{'commit': 2}, {'commit': 3}]
        mock_responses[14].json.return_value = [{'commit': 2}, {'commit': 5}]
        mock_responses[15].json.return_value = [{'commit': 2}, {'commit': 5}]
