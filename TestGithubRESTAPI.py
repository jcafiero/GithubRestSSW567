...
class TestGithubRESTAPI(unittest.TestCase):
    ...
    def testJcafiero(self, mock_get):
        ...
        self.assertEqual(list_github_user_repos('jcafiero'), [('Courses', 17), ('flawless', 16),  ('future_shop', 15), ('GithubRestSSW567', 18), ('HackerRank',20), ('HackerRank2DArray', 2), ('HackPrinceton2016', 62), ('HackRU2018', 28), ('hello-world', 4), ('jcafiero.github.io', 30), ('LargestPalindromeProduct', 12), ('ProjectEuler-59-XOR-Decryption', 3),('SSW567ClassifyTriangles', 5), ('TriangleSSW567', 5)])
