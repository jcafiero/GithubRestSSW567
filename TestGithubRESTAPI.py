...
class TestGithubRESTAPI(unittest.TestCase):
    ...
    def testJcafiero(self, mock_get):
        ...
        mock_responses[4].json.return_value = [{'commit': 2}, {'commit': 2}, {'commit': 2}, {'commit': 2}, {'commit': 2}, {'commit': 2}, {'commit': 2}, {'commit': 2}, {'commit': 9}, {'commit': 10}, {'commit': 11}, {'commit': 12}, {'commit': 2},{'commit': 2}, {'commit': 2}, {'commit': 2}]
