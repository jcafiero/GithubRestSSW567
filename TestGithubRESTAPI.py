...
class TestGithubRESTAPI(unittest.TestCase):
    ...
    def testJcafiero(self, mock_get):
        ...
        mock_responses[4].json.return_value = [{'commit': 2}, {'commit': 2}, {'commit': 2}, {'commit': 2}, {'commit': 2}, {'commit': 2}, {'commit': 2}, {'commit': 2}, {'commit': 2}, {'commit': 2}, {'commit': 2}, {'commit': 2}, {'commit': 2}, {'commit': 2}, {'commit': 2}, {'commit': 2}, {'commit': 2}, {'commit': 2}, {'commit': 19}]
        ...
        self.assertEqual(list_github_user_repos('jcafiero'), [('Courses', 17), ('flawless', 16),  ('future_shop', 15), ('GithubRestSSW567', 19), ('HackerRank',20), ('HackerRank2DArray', 2), ('HackPrinceton2016', 30), ('HackRU2018', 28), ('hello-world', 4), ('jcafiero.github.io', 2), ('LargestPalindromeProduct', 12), ('ProjectEuler-59-XOR-Decryption', 12),('SSW567ClassifyTriangles', 3), ('TriangleSSW567', 5)])
